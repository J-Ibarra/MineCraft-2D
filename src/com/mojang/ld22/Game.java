...
public class Game extends Canvas implements Runnable {
	...
	public static final int HEIGHT = (int) (120);
	public static final int WIDTH = (int) (160);
	...
	private void init() {
		...
		try {
			sheet = new SpriteSheet(ImageIO.read(Game.class.getResourceAsStream("/icons.png")));
	...
	public void run() {
		...
		while (running) {
			...
			if (System.currentTimeMillis() - lastTimer1 > 1000) {
				lastTimer1 += 1000;
				frame.setTitle(Game.NAME + " | " + ticks + " ticks, " + frames + " fps");
	...
	private void renderGui() {
		...
		if (player.activeItem != null) {
			player.activeItem.renderInventory(screen, 10 * 8, screen.h - 8 * 3);
		}
